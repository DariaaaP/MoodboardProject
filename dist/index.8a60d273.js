...
})({"ksbkW":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "hetPost", ()=>hetPost);
async function hetPost(url) {
    ...
    let cardsContent = "";
    let cards = data.sad;
    for (let card of newCards)cardsContent += `<div class = 'card'>                        
            <h2>${card.title}</h2>
...
},{}]},["ksbkW","dVfCV"], "dVfCV", "parcelRequired178")

//# sourceMappingURL=index.8a60d273.js.map
